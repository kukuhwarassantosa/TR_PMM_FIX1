...
public class MainActivityChemistry extends ListActivity {
    ...
    private static String url = "http://archive.org/advancedsearch.php?q=chemistry%20video&fl[]=mediatype&fl[]=title&sort[]=&sort[]=&sort[]=&rows=10&page=1&indent=yes&output=json";
